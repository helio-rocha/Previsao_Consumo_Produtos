...
data_limite = '2024-11-02 04:00:00'
...
model = ExponentialSmoothing(endog=df_cortado, trend='add').fit()
...
start_date = '2024-11-02 03:00:00'  # Ajuste as datas de início e fim conforme necessário
end_date = '2024-11-02 05:00:00'
